        ...
        <div class="card-body">
            ...
            <form action="{{ route('barangmasuk.index') }}" method="GET">
                <div class="row ml-2" style="gap: 10px;">
                    ...
                    <a href="{{ route('barangmasuk.index') }}" class="btn btn-danger " type="submit">Reset</a>
                </div>
            </form>
            ...
            <div class="row mt-3 ml-1" style="gap: 10px">
                @if (!$masuk->isEmpty())
                    <a href="{{ route('barangmasuk.index', ['download_pdf' => true, 'tanggal_awal' => request('tanggal_awal'), 'tanggal_akhir' => request('tanggal_akhir')]) }}"
                        class="btn btn-danger ">Buat
                        PDF</a>
                    <a href="{{ route('barangmasuk.index', ['download_excel' => true, 'tanggal_awal' => request('tanggal_awal'), 'tanggal_akhir' => request('tanggal_akhir')]) }}"
            ...
            {{-- INI BUAT SEACRH --}}
            Cari : <input type="text" placeholder="cari barang" class="mt-3 mb-2" id="myInputBarangMasuk"
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $("#myInputBarangMasuk").on("keyup", function() {
